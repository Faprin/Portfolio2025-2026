...
He construido mi portfolio personal bajo la premisa de la **excelencia técnica y la experiencia de usuario**. No es solo una web; es una declaración de intenciones sobre cómo cuido el rendimiento y el detalle.

### Tech Stack del Proyecto:
* **Astro:** Elegido por su arquitectura de islas y su rendimiento inigualable (casi cero JS por defecto).
...
* **Deep Learning desde cero:** Estudiando la serie *Zero to Hero* de Andrej Karpathy para construir arquitecturas Transformer y motores de autograduación manualmente.
